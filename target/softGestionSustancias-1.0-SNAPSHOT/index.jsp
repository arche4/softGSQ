...
<html lang="en">
    ...
    <body class="bg-gradient-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small" href="forgot-password.html">Se te olvido la contraseña?</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="${pageContext.servletContext.contextPath}/lib/js/sb-admin-2.min.js" type="text/javascript"></script>
    </body>
